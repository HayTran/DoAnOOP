...
namespace QuanLyCuaHang
{
    class KhoHang: KetNoiDuLieu
    {
        ...
        public KhoHang (string maMH, string tenMH, string soLuong, string giaTien, string ngayNhap, string ngaySanXuat, string hanSuDung, string nguoiNhap)
        {
            this.maMH  = maMH;
            this.tenMH = tenMH;
        ...
        // lưu dữ liệu mua hàng của khách hàng.
